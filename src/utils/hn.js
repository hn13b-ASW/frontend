...
/**
 * Funcion para votar (upvote, unvote o downvote)
 * @param {string} id - El ID del elemento a votar.
 * @param {string} how - Accion de voto: "up", "down" o "un" (unvote).
 * @param {string} auth - Token de autenticacion.
 * @param {string} _goto - URL de redireccion.
 */
export function vote (id, how, auth, _goto) {
  vis($("up_" + id), how == 'un');
  vis($("down_" + id), how == 'un');
  var unv = '';
  if (how != 'un') {
